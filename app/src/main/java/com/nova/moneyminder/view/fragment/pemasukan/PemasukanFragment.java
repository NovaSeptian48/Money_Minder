package com.nova.moneyminder.view.fragment.pemasukan;
...
import com.nova.moneyminder.view.fragment.pemasukan.add.AddPemasukanActivity;
    ...
    public void onDelete(ModelDatabase modelDatabase) {
        ...
        alertDialogBuilder.setPositiveButton("Hapus", (dialogInterface, i) -> {
            ...
            if (sKeterangan.equals("OK")) {
                Toast.makeText(requireContext(), "Catatan sudah dihapus",
