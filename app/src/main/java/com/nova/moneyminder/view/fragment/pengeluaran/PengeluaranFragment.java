package com.nova.moneyminder.view.fragment.pengeluaran;
...
import com.nova.moneyminder.utils.FunctionHelper;
import com.nova.moneyminder.view.fragment.pengeluaran.add.AddPengeluaranActivity;
...
public class PengeluaranFragment extends Fragment implements PengeluaranAdapter.PengeluaranAdapterCallback {
    ...
    public void onDelete(ModelDatabase modelDatabase) {
        ...
        alertDialogBuilder.setMessage("Hapus catatan ini? ");
        alertDialogBuilder.setPositiveButton("Hapus", (dialogInterface, i) -> {
            ...
            if (sKeterangan.equals("OK")) {
                Toast.makeText(requireContext(), "Catatan sudah dihapus", Toast.LENGTH_SHORT).show();
            }
        });
